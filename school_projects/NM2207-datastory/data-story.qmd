...
*Relationship between Sleep quality and social media usage*\
First, we will compare the sleep quality and the concentration ability between respondents who use social media, and those who do not use social media. From the heat map, it is evident that those who do not use social media never, or seldom face issues with regards to sleeping as the respondents generally chose between 1 and 2 only. On the other hand, as we move over to the heat map for those we use social media, the darkest of area of the heat map is at the top (where respondents chose 5 as their response). As we hover over the heat map, a total of 110 and 124 respondents chose 4 and 5 respectively in response to the survey question of "On the scale of 1 to 5, how often do you face issues regarding sleep". The largest group of respondents who use social media indicated that they often face such issues.

*Relationship between Social Media usage and concentration ability*\
