...
*Concentration*\
In this section, we will investigate the relationship between the use of social media and concentration of respondents
```{r, eval=T,echo=FALSE}
# Comparison between those who use, and do not use SM on whether they find it difficult to concentrate on things 
concentration <- social_media_health %>% 
  select(X6..Do.you.use.social.media., X14..Do.you.find.it.difficult.to.concentrate.on.things.)

ggplot(concentration, aes(x = X6..Do.you.use.social.media., y = X14..Do.you.find.it.difficult.to.concentrate.on.things.)) +
  geom_violin(aes(fill = X6..Do.you.use.social.media.), scale = "width") +
  labs(
    title = "Comparison of concentration ability",
    caption = "Note: 1 being no difficulty faced, and 5 being very difficult",
    x = "Do you use social media?",
    y = "Difficulty in concentrating on things",
    fill = "Do you use social media?")
...
ggplot(data = as.data.frame(SM_worries_heatmap), aes(x = Var1, y = Var2, fill = Freq)) +
  geom_tile() +
