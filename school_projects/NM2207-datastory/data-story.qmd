...
<iframe height="500" width="100%" frameborder="no" src="https://liyinnng.shinyapps.io/HeatmapShinyApp/"> </iframe>
...
- While it appears that most are not negatively affected by these comparisons and  indicate that they are neutral towards these comparisons ("3" has the highest count), there is a more telling trend as we click into the "Child" age group on the shiny app.

<sub> Note: 1 indicates seldom compare, and 5 indicates compare very frequently </sub>
