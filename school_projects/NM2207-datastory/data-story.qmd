...
crosstalk_data <- SharedData$new(social_media_health)

# Define a filter_slider for X1..What.is.your.age.
age_filter <- filter_slider(
  id = "age",
  label = "Age Range",
  sharedData = crosstalk_data,
  column = ~X1..What.is.your.age.,
  ticks = TRUE,
  dragRange = TRUE,  # Allow range selection
  step = 1,
  sep = "",
  width = "90%"
)
